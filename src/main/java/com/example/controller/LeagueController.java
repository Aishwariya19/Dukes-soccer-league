...
import com.example.model.NewLeague;
...
public class LeagueController {
    ...
    @RequestMapping("/addNewLeague")
    public String addNewLeague()
    {
        return "addNewLeague";
    }
    @RequestMapping("/processAddLeague")
    public String processAddLeague(@RequestParam("title")String title, @RequestParam("season") String season, Model model)
    {
        ...
        {
            NewLeague myleague=new NewLeague();
            myleague.setSeason(season);
            myleague.setTitle(title);

            model.addAttribute("LEAGUE",myleague);
            return "success1";
        }
